...
inline fun ClusterAdminClient.health(listener: ActionListener<ClusterHealthResponse>, block: ClusterHealthRequest.() -> Unit) =
...
inline fun ClusterAdminClient.state(listener: ActionListener<ClusterStateResponse>, block: ClusterStateRequest.() -> Unit) =
...
inline fun ClusterAdminClient.updateSettings(listener: ActionListener<ClusterUpdateSettingsResponse>, block: ClusterUpdateSettingsRequest.() -> Unit) =
...
inline fun ClusterAdminClient.reroute(listener: ActionListener<ClusterRerouteResponse>, block: ClusterRerouteRequest.() -> Unit) =
...
inline fun ClusterAdminClient.nodesInfo(listener: ActionListener<NodesInfoResponse>, block: NodesInfoRequest.() -> Unit) =
...
inline fun ClusterAdminClient.clusterStats(listener: ActionListener<ClusterStatsResponse>, block: ClusterStatsRequest.() -> Unit) =
...
inline fun ClusterAdminClient.nodesStats(listener: ActionListener<NodesStatsResponse>, block: NodesStatsRequest.() -> Unit) =
...
inline fun ClusterAdminClient.nodesUsage(listener: ActionListener<NodesUsageResponse>, block: NodesUsageRequest.() -> Unit) =
...
inline fun ClusterAdminClient.nodesHotThreads(listener: ActionListener<NodesHotThreadsResponse>, block: NodesHotThreadsRequest.() -> Unit) =
...
inline fun ClusterAdminClient.listTasks(listener: ActionListener<ListTasksResponse>, block: ListTasksRequest.() -> Unit) =
...
inline fun ClusterAdminClient.getTask(listener: ActionListener<GetTaskResponse>, block: GetTaskRequest.() -> Unit) =
...
inline fun ClusterAdminClient.cancelTasks(listener: ActionListener<CancelTasksResponse>, block: CancelTasksRequest.() -> Unit) =
...
inline fun ClusterAdminClient.searchShards(listener: ActionListener<ClusterSearchShardsResponse>, block: ClusterSearchShardsRequest.() -> Unit) =
...
inline fun ClusterAdminClient.putRepository(listener: ActionListener<AcknowledgedResponse>, block: PutRepositoryRequest.() -> Unit) =
...
inline fun ClusterAdminClient.deleteRepository(listener: ActionListener<AcknowledgedResponse>, block: DeleteRepositoryRequest.() -> Unit) =
...
inline fun ClusterAdminClient.getRepositories(listener: ActionListener<GetRepositoriesResponse>, block: GetRepositoriesRequest.() -> Unit) =
...
inline fun ClusterAdminClient.verifyRepository(listener: ActionListener<VerifyRepositoryResponse>, block: VerifyRepositoryRequest.() -> Unit) =
...
inline fun ClusterAdminClient.createSnapshot(listener: ActionListener<CreateSnapshotResponse>, block: CreateSnapshotRequest.() -> Unit) =
...
inline fun ClusterAdminClient.getSnapshots(listener: ActionListener<GetSnapshotsResponse>, block: GetSnapshotsRequest.() -> Unit) =
...
inline fun ClusterAdminClient.deleteSnapshot(listener: ActionListener<AcknowledgedResponse>, block: DeleteSnapshotRequest.() -> Unit) =
...
inline fun ClusterAdminClient.restoreSnapshot(listener: ActionListener<RestoreSnapshotResponse>, block: RestoreSnapshotRequest.() -> Unit) =
...
inline fun ClusterAdminClient.pendingClusterTasks(listener: ActionListener<PendingClusterTasksResponse>, block: PendingClusterTasksRequest.() -> Unit) =
...
inline fun ClusterAdminClient.snapshotsStatus(listener: ActionListener<SnapshotsStatusResponse>, block: SnapshotsStatusRequest.() -> Unit) =
...
inline fun ClusterAdminClient.putPipeline(id: String, source: BytesReference, xContentType: XContentType, listener: ActionListener<AcknowledgedResponse>, block: PutPipelineRequest.() -> Unit) =
...
inline fun ClusterAdminClient.deletePipeline(id: String, listener: ActionListener<AcknowledgedResponse>, block: DeletePipelineRequest.() -> Unit) =
...
inline fun ClusterAdminClient.getPipeline(listener: ActionListener<GetPipelineResponse>, block: GetPipelineRequest.() -> Unit) =
...
inline fun ClusterAdminClient.simulatePipeline(source: BytesReference, xContentType: XContentType, listener: ActionListener<SimulatePipelineResponse>, block: SimulatePipelineRequest.() -> Unit) =
...
inline fun ClusterAdminClient.allocationExplain(listener: ActionListener<ClusterAllocationExplainResponse>, block: ClusterAllocationExplainRequest.() -> Unit) =
...
inline fun ClusterAdminClient.deleteStoredScript(id: String, listener: ActionListener<AcknowledgedResponse>, block: DeleteStoredScriptRequest.() -> Unit) =
...
inline fun ClusterAdminClient.putStoredScript(listener: ActionListener<AcknowledgedResponse>, block: PutStoredScriptRequest.() -> Unit) =
...
inline fun ClusterAdminClient.getStoredScript(id: String, listener: ActionListener<GetStoredScriptResponse>, block: GetStoredScriptRequest.() -> Unit) =
